...
```bash
yarn add react-native-nitro-modules@0.35.10 react-native-nitro-geolocation@2.0.0-rc.6
```
...
The 2.0.0-rc.6 repository currently builds and runs its consumer contracts with
