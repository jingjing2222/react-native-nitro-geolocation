...
```bash
yarn add react-native-nitro-modules@0.35.10 react-native-nitro-geolocation@2.0.0-rc.8
```
...
The 2.0.0-rc.8 repository currently builds and runs its consumer contracts with
...
Reference last reviewed for `2.0.0-rc.8` on **2026-09-10**. Consult the current
