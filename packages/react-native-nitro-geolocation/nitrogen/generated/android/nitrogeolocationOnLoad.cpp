...
void registerAllNatives() {
  ...
  margelo::nitro::nitrogeolocation::JFunc_void_std__vector_ReverseGeocodedAddress__cxx::registerNatives();
  margelo::nitro::nitrogeolocation::JFunc_void_Heading_cxx::registerNatives();
