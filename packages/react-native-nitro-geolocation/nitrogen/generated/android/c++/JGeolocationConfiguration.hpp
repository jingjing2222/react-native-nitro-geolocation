...
namespace margelo::nitro::nitrogeolocation {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrogeolocation/GeolocationConfiguration;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct GeolocationConfiguration by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    GeolocationConfiguration toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JGeolocationConfiguration::javaobject> fromCpp(const GeolocationConfiguration& value) {
      using JSignature = JGeolocationConfiguration(jni::alias_ref<jni::JBoolean>, jni::alias_ref<JAuthorizationLevel>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<JLocationProvider>);
      static const auto clazz = javaClassStatic();
