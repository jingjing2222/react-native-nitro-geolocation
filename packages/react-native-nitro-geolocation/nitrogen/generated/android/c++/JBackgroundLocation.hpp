...
namespace margelo::nitro::nitrogeolocation {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrogeolocation/BackgroundLocation;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct BackgroundLocation by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    BackgroundLocation toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JBackgroundLocation::javaobject> fromCpp(const BackgroundLocation& value) {
      using JSignature = JBackgroundLocation(jni::alias_ref<jni::JString>, jni::alias_ref<JBackgroundLocationSource>, jboolean, jni::alias_ref<JLocationProviderUsed>, jni::alias_ref<jni::JBoolean>, double, jni::alias_ref<JDetectedActivity>, jni::alias_ref<JBatterySnapshot>, jni::alias_ref<JGeolocationCoordinates>, double);
      static const auto clazz = javaClassStatic();
