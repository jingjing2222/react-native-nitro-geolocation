///
/// ModernGeolocationResponse.swift
...
/**
 * Represents an instance of `ModernGeolocationResponse`, backed by a C++ struct.
 */
public typealias ModernGeolocationResponse = margelo.nitro.nitrogeolocation.ModernGeolocationResponse

public extension ModernGeolocationResponse {
  private typealias bridge = margelo.nitro.nitrogeolocation.bridge.swift

  /**
   * Create a new instance of `ModernGeolocationResponse`.
   */
