...
namespace margelo::nitro::nitrogeolocation {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ModernGeolocationResponse).
   */
  struct ModernGeolocationResponse final {
  public:
  ...
  public:
    ModernGeolocationResponse() = default;
    explicit ModernGeolocationResponse(std::optional<bool> mocked, std::optional<LocationProviderUsed> provider, GeolocationCoordinates coords, double timestamp): mocked(mocked), provider(provider), coords(coords), timestamp(timestamp) {}

  public:
    friend bool operator==(const ModernGeolocationResponse& lhs, const ModernGeolocationResponse& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ModernGeolocationResponse <> JS ModernGeolocationResponse (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrogeolocation::ModernGeolocationResponse> final {
    static inline margelo::nitro::nitrogeolocation::ModernGeolocationResponse fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrogeolocation::ModernGeolocationResponse(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrogeolocation::ModernGeolocationResponse& arg) {
