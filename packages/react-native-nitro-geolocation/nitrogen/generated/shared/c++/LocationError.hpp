...
namespace margelo::nitro::nitrogeolocation {
  ...
  /**
   * A struct which can be represented as a JavaScript object (LocationError).
   */
...
namespace margelo::nitro {
  ...
  // C++ LocationError <> JS LocationError (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrogeolocation::LocationError> final {
