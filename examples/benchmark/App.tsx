...
export default function BenchmarkScreen() {
  ...
  const benchmarkNitro = async () => {
    ...
    const getCurrentStats =
      await runGetCurrentPositionBenchmark(getCurrentPosition);
    ...
    Alert.alert(
      `Success Nitro Benchmark Completed\n\n setRNConfiguration: ${setRNConfigStats.avg.toFixed(
        3
      )}ms\n getCurrentPosition: ${getCurrentStats.avg.toFixed(
        2
  ...
  const benchmarkCommunity = async () => {
    ...
    Alert.alert(
      `Success Community Benchmark Completed\n\n setRNConfiguration: ${setRNConfigStats.avg.toFixed(
        3
      )}ms\n getCurrentPosition: ${getCurrentStats.avg.toFixed(
        2
      )}ms\n watchPosition: ${watchStats.avg.toFixed(1)}ms`
